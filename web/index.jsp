        ...
        <table border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="animalController?op=Editar&idAnimal=<%= Animal.getIdAnimal()%>" style="margin-right: 10px;">Editar</a>
                        <a href="animalController?op=Borrar&idAnimal=<%= Animal.getIdAnimal()%>">Borrar</a>
                    </td>
                </tr>
                <% } %>
            </tbody>
