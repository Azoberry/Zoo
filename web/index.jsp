        ...
        <div class="w-5/12 border-2 border-white fondo-color py-2 px-14 rounded-3xl relative">
          ...
          <form action="/Zoo/userController" method="POST">
            ...
            <div class="relative h-20 w-full min-w-[200px]">
              ...
              <input type="text" placeholder="CORREO" class="w-full h-full rounded-2xl pl-20 text-3xl" name="correo">
            </div>
            <br>
            <!-- TEXTO -->
            <p class="w-fit mx-auto text-3xl text-white text-border font-bold text-background">¿Olvidaste tu contraseña?</p>
            <p class="text-center">
            ...
            <div class="relative h-20 w-full min-w-[200px]">
              ...
              <input type="password" placeholder="CONTRASEÑA" class="w-full h-full rounded-2xl pl-20 text-3xl" name="contrasena">
            </div>
            <!-- TEXTO -->
            <br>
            ...
            text-3xl font-semibold absolute right-20" name="op" value="IniciarSesion">Iniciar Sesión</button>
          </form>
          <br><br><br><br>
        </div>
      </div>
