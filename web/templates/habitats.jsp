      ...
      <div class="flex">
        ...
        <div class="m-0 p-0 w-full bg-white">
          ...
          <div class="h-fit pb-10 m-0 p-0 mb-10 border-b-[3px] rounded-b-3xl shadow-2xl border-black">
            <h1 class="text-center pt-10 text-3xl text-black font-medium">¡Aquí podras ver todas las habitats que existen en el Zoologico!</h1>
          </div>
          <div class="aspect-video flex justify-center">
            <img src="public/mapa.png" alt="mapa del zoologico que contiene los habitats disponibles">
          </div>
          <br>
        </div>
      </div>
