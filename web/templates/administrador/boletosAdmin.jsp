...
<html>
    <head>
        ...
        <title>Boletos Administrador</title>
  ...
  <div class="flex">
    ...
    <div class="border-2 w-screen h-screen bg-white">
      <div class="h-fit pb-10 m-0 p-0 mb-10 border-b-[3px] rounded-b-3xl shadow-2xl border-black">
        <h1 class="text-center pt-10 text-3xl text-black font-medium">Resumen de tipos de boletos del Zoologico</h1>
      </div>
      <div class="container mx-auto border-2 border-black overflow-x-auto">
        <table>
          ...
          <tr class="text-lg">
            <td>1</td>
            <td>Junior</td>
            <td>¡Valido desde los 2 años hasta los 12 años!</td>
            <td>40</td>
          </tr>
          <tr class="text-lg">
            <td>2</td>
            <td>Estandar</td>
            <td>¡Valido desde los 12 años para arriba!</td>
            <td>65</td>
          </tr>
          <tr class="text-lg">
            <td>3</td>
            <td>Combo</td>
            <td>¡Valido desde el lunes hasta el jueves!</td>
            <td>50</td>
          </tr>
        </table>
      </div>
