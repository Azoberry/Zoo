      ...
      <div class="dropdown dropdown-end">
        <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
          <div class="w-10 rounded-full">
            <img alt="avatar de usuario" src="templates/public/admin.png"/>
          </div>
        </div>
  ...
  <div class="flex">
    ...
    <div class="flex flex-col w-2/12 bg-white py-10 m-0 border-r-2 border-black">
      <div class="flex flex-row flex-wrap px-6 w-[100%]">
          <a href="templates/administrador/animalTablasAdmin.jsp" class="flex flex-wrap gap-x-8">
      ...
      <div class="flex flex-row flex-wrap px-6 w-[100%]">
        <a href="templates/administrador/boletosAdmin.jsp" class="flex flex-wrap gap-x-8">
      ...
      <div class="flex flex-row flex-wrap px-6 w-[100%]">
        <a href="templates/administrador/historial.jsp" class="flex flex-wrap gap-x-9">
      ...
      <div class="flex flex-row flex-wrap px-6 w-[100%]">
        <a href="templates/administrador/habitatTablasAdmin.jsp" class="flex flex-wrap gap-x-8">
      ...
      <div class="flex flex-row flex-wrap px-6 w-[100%]">
        <a href="templates/administrador/zonaTablasAdmin.jsp" class="flex flex-wrap gap-x-8">
          <img src="templates/public/barraLateral/zona.png" alt="imagen para la sección de animales" class="size-12 float-left">
          <p class="float-right leading-[50px] text-black font-medium text-3xl font-['K2D'] mb-7
          hover:underline">Zonas</p>
        </a>
      </div>
      <div class="flex flex-row flex-wrap px-6 w-[100%]">
        <a href="templates/administrador/usuarioTablasAdmin.jsp" class="flex flex-wrap gap-x-8">
          <img src="templates/public/barraLateral/usuario.svg" alt="imagen para la sección de animales" class="size-12 float-left">
          <p class="float-right leading-[50px] text-black font-medium text-3xl font-['K2D'] mb-7 opacity-0 lg:opacity-100
    ...
    <div class="border-2 w-screen h-screen bg-white">
      <div class="h-fit pb-10 m-0 p-0 mb-10 border-b-[3px] rounded-b-3xl shadow-2xl border-black">
        <h1 class="text-center pt-10 text-3xl text-black font-medium">Editar Animal</h1>
      </div>
      <div class="container mx-auto border-2 border-black overflow-x-auto">
        <form action="/Zoo/animalController" method="POST">
            <div>
                ...
                <input type="text" value="${Animal.getNombre()}" name="nombre"
                class="border-black border-2 rounded-lg text-black bg-white"><br>

                <label class="text-2xl text-black font-semibold">Apodo</label>
                <input type="text" value="${Animal.getApodo()}" name="apodo"
                class="border-black border-2 rounded-lg text-black bg-white"><br>
                
                <label class="text-2xl text-black font-semibold">Dieta</label>
                <input type="text" value="${Animal.getDieta()}" name="dieta"
                class="border-black border-2 rounded-lg text-black bg-white"><br>
                
                <label class="text-2xl text-black font-semibold">Descripcion</label>
                <input type="text" value="${Animal.getDescripcion()}" name="descripcion"
                class="border-black border-2 rounded-lg text-black bg-white"><br>
                
                <label class="text-2xl text-black font-semibold">Habitat Natural</label>
                <input type="text" value="${Animal.getHabitatNat()}" name="habitatNat"
                class="border-black border-2 rounded-lg text-black bg-white"><br>

                <label class="text-2xl text-black font-semibold">Sexo</label>
                <input type="text" value="${Animal.getSexo()}" name="sexo"
                class="border-black border-2 rounded-lg text-black bg-white"><br>
                
                <label class="text-2xl text-black font-semibold">Edad</label>
                <input type="text" value="${Animal.getEdad()}" name="edad"
                class="border-black border-2 rounded-lg text-black bg-white"><br>
                
                <label class="text-2xl text-black font-semibold">Peso</label>
                <input type="text" value="${Animal.getPeso()}" name="peso"
                class="border-black border-2 rounded-lg text-black bg-white"><br>
                
                <label class="text-2xl text-black font-semibold">Tamaño</label>
                <input type="text" value="${Animal.getTamano()}" name="tamano"
                class="border-black border-2 rounded-lg text-black bg-white"><br>
                
                <label class="text-2xl text-black font-semibold">idHabitat</label>
                <input type="text" value="${Animal.getIdHabitat()}" name="idHabitat"
                class="border-black border-2 rounded-lg text-black bg-white"><br>
            </div>
            <br>
            <input type="submit" name="op" value="Actualizar" class="border-2 border-black text-xl text-black rounded-lg py-2 px-5 bg-green-400">
        </form>
      </div>
    </div>
  </div>
