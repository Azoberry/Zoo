      ...
      <div class="flex">
        ...
        <div class="border-2 w-screen h-screen bg-white">
          <div class="text-center h-fit pb-10 m-0 p-0 mb-10 border-b-[3px] rounded-b-3xl shadow-2xl border-black text-3xl text-black font-['K2D'] py-[30px]"">
            <h1 class="text-center pt-10 text-3xl text-black font-medium">Resumen de Zonas en el Zoologico</h1>
            <a href="agregarZonas.jsp" type="submit" class="bg-gray-300 text-black w-fit h-fit py-1 px-5 rounded-2xl">
              <div class="flex">
