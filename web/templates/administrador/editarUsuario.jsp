        ...
        <div class="border-2 w-screen h-screen bg-white">
          ...
          <div class="container mx-auto border-2 border-black overflow-x-auto">
            <form action="/Zoo/userController" method="POST">
              <div>
                  <label class="text-2xl text-black font-semibold">idUsuario</label>
                  <input type="text" value="${User.getIdUsuario()}" disabled
                  ...
                  <input type="text" value="${User.getNombre()}" name="nombre"
                  class="border-black border-2 rounded-lg text-black bg-white"><br>

                  <label class="text-2xl text-black font-semibold">Apellido Paterno</label>
                  <input type="text" value="${User.getApellidoP()}" name="apellidoP"
                  class="border-black border-2 rounded-lg text-black bg-white"><br>

                  <label class="text-2xl text-black font-semibold">Apellido Materno</label>
                  <input type="text" value="${User.getApellidoM()}" name="apellidoM"
                  class="border-black border-2 rounded-lg text-black bg-white"><br>

                  <label class="text-2xl text-black font-semibold">Correo</label>
                  <input type="text" value="${User.getCorreo()}" name="correo"
                  class="border-black border-2 rounded-lg text-black bg-white"><br>

                  <label class="text-2xl text-black font-semibold">Contraseña</label>
                  <input type="text" value="${User.getContrasena()}" name="contrasena"
                  class="border-black border-2 rounded-lg text-black bg-white"><br>

                  <label class="text-2xl text-black font-semibold">Edad</label>
                  <input type="text" value="${User.getEdad()}" name="edad"
                  class="border-black border-2 rounded-lg text-black bg-white"><br>

                  <label class="text-2xl text-black font-semibold">Sexo</label>
                  <input type="text" value="${User.getSexo()}" name="sexo"
                  class="border-black border-2 rounded-lg text-black bg-white"><br>

                  <label class="text-2xl text-black font-semibold">Privilegio</label>
                  <input type="text" value="${User.getPrivilegio()}" name="privilegio"
                  class="border-black border-2 rounded-lg text-black bg-white"><br>
              </div>
              <br>
